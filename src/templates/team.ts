                                ...
                                <tbody>
                                  <tr>
                                    <td>
                                      <div align="center">
                                        <a href="${cta}"
                                          style="background-color:#bbf2ee;border-bottom:0px solid #000000;border-left:0px solid #000000;border-radius:26px;border-right:0px solid #000000;border-top:0px solid #000000;color:#000000;display:inline-block;font-family:'Montserrat','Trebuchet MS','Lucida Grande','Lucida Sans Unicode','Lucida Sans',Tahoma,sans-serif;font-size:14px;font-weight:700;padding-bottom:5px;padding-top:5px;text-align:center;text-decoration:none;width:auto;word-break:keep-all"
                                          target="_blank"
                                          data-saferedirecturl="${cta}">
                                          <span style="word-break:break-word;padding-left:20px;padding-right:20px;font-size:14px;display:inline-block;letter-spacing:normal">
                                            <span style="word-break:break-word;line-height:28px">SET UP ACCOUNT</span>
                                          </span>
                                        </a>
                                      </div>
                                    </td>
